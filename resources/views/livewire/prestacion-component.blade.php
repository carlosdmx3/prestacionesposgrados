...
<tr>
    ...
    <td width="5%" colspan="7">
        <p class="radio" style="font-weight: normal;">
            ...
            <br>
                <input  type="radio" name="modalidad" id="modalidadps" value="B" 
                        wire:model="omodalidad_ps"
                        wire:click="modalidadPS('B')">
                B) Obra Pedagógica 
            <br>
                <input  type="radio" name="modalidad" id="modalidadps" value="C" 
                        wire:model="omodalidad_ps"
                        wire:click="modalidadPS('C')">
                C) Estudios de posgrado 
            <br>
                <input  type="radio" name="modalidad" id="modalidadps" value="D" 
                        wire:model="omodalidad_ps"
