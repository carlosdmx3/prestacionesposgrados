...
(function(n) {
    ...
    function O(a, c) {
        ...
        n.each(c, function(d, b) {
            if (n.isPlainObject(b))
                ...
                J && (-1 === b.indexOf("<?xml") && (b = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + b),
    ...
    function y(a, c, d) {
        ...
        d && (d.attr && n(b).attr(d.attr),
        d.children && n.each(d.children, function(m, e) {
            b.appendChild(e)
        }),
    ...
    D.ext.buttons.copyHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.copy", "Copiar <i class='fa fa-files-o'></i>")
        },
    ...
    D.ext.buttons.csvHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.csv", "CSV <i class='fa fa-file-text'></i>")
        },
        action: function(a, c, d, b) {
            this.processing(!0);
            a = S(c, b).str;
            ...
            !1 !== m ? (m || (m = x.characterSet || x.charset),
            m && (m = ";charset=" + m)) : m = "";
    ...
    D.ext.buttons.excelHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.excel", "Excel <i class='fa fa-file-excel-o'></i>")
        },
        action: function(a, c, d, b) {
            this.processing(!0);
            var m = this
            ...
            r.title && (q([r.title], e),
            v(e, p.header.length - 1));
            r.messageTop && (q([r.messageTop], e),
            v(e, p.header.length - 1));
            b.header && (q(p.header, e),
            n("row:last c", f).attr("s", "2"));
            d = e;
            var w = 0;
            for (var C = p.body.length; w < C; w++)
                q(p.body[w], e);
            w = e;
            b.footer && p.footer && (q(p.footer, e),
            n("row:last c", f).attr("s", "2"));
            r.messageBottom && (q([r.messageBottom], e),
            v(e, p.header.length - 1));
            q = y(f, "cols");
    ...
    D.ext.buttons.pdfHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.pdf", "PDF <i class='fa fa-file-pdf-o'></i>")
        },
        action: function(a, c, d, b) {
            this.processing(!0);
