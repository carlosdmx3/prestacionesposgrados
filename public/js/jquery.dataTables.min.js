...
(function(h) {
    ...
    function qb(a) {
        var b = a.oClasses
          ...
          , e = a.oPreviousSearch
          , f = a.aanFeatures
          , g = '<input type="Buscar" class="' + b.sFilterInput + '" size="10"/>'
          , j = d.sSearch
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "<span style=font-size:11px; color: ><b>No hay datos disponibles en la tabla</b></span>",
            sInfo: "<span style=font-size:11px; color: ><b>Mostrando  (_START_  a  _END_)  de _TOTAL_ registros </b></span>",
            sInfoEmpty: "<span style=font-size:11px; color: ><b>Mostrando 0  -  0 de 0 registros</b></span>",
            sInfoFiltered: "(<span style=font-size:11px; color: ><b>Filtrado de  _MAX_  registros)</b></span>",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "&nbsp;&nbsp;&nbsp;<span style=font-size:11px; color: ><b>Mostrar </b>_MENU_ <b>registros</b></span>",
            sLoadingRecords: "Loading...",
            sProcessing: "Procesando...",
            sSearch: "<span style=font-size:12px; color: ><b><i class='fa fa-search'></i>&nbsp;&nbsp;Buscar programa:</b></span>",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "<span style=font-size:11px; color: ><b>No hay registros que coincidan</b></span>"
        },
